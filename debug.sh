if [ "$1" = "kins_debug" ]; then
    ...
    python -m debugpy --listen 9279 --wait-for-client run.py --type evaluate --eval_model_name 134.pth --cfg_file configs/kins_snake.yaml test.dataset KinsVal
